...
const Footer = () => {
  return (
    <div className="flex flex-col items-center justify-center gap-5 h-80 bg-slate-200 dark:bg-slate-900 dark:text-white">
      <p className="text-4xl font-medium text-newblue dark:text-violet-500">FocusLearn.online</p>
      ...
      <div className="mt-10" >Made with ❤ by <a
          className="transition duration-300 text-blue-400 hover:text-blue-600 hover:scale-110"
          href="https://www.linkedin.com/in/bibekghoshh/"
          target="black"
        >
        BIBEK GHOSH
